...
{
//    [_delegate getLocationTextFiled:[_locationTextFiled.text integerValue]];
//    [_delegate getNameTextFiled:_nameTextFiled.text];
//    [_delegate getNumTextFiled:[_numTextFiled.text integerValue]];
//    [_delegate getMathTextFiled:[_mathTextFiled.text integerValue]];
//    [_delegate getPETextFiled:[_peTextFiled.text integerValue]];
//    [_delegate getCreditTextFiled:[_creditTextFiled.text integerValue]];
